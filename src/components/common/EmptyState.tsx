    ...
    <div className="flex flex-col items-center justify-center py-16 md:py-24 px-4" role="status" aria-live="polite">
      ...
      {action && (
        <button
          ...
          className="group rounded-lg text-base md:text-lg inline-flex items-center justify-center gap-2 text-black border-3 border-black dark:border-white dark:text-white transition-all ease-in-out duration-200 shadow-[6px_6px_0px_0px] hover:shadow-[8px_8px_0px_0px] active:shadow-[0px_0px_0px_0px] active:translate-x-2 active:translate-y-2 dark:shadow-white shadow-black bg-purple-300 dark:bg-purple-700 px-6 py-3 font-semibold"
...
export const ErrorState = ({ message, onRetry }: { message?: string; onRetry?: () => void }) => {
  return (
    <div className="flex flex-col items-center justify-center py-16 md:py-24 px-4" role="alert" aria-live="assertive">
      <div className="bg-red-100 dark:bg-red-950/30 border-3 border-red-500 dark:border-red-700 rounded-lg p-6 md:p-8 max-w-md text-center shadow-[4px_4px_0px_0px] shadow-red-500 dark:shadow-red-700">
        ...
        {onRetry && (
          <button
            onClick={onRetry}
            className="rounded-lg text-base inline-flex items-center justify-center text-white border-3 border-red-700 dark:border-red-500 transition-all ease-in-out duration-200 shadow-[4px_4px_0px_0px] hover:shadow-[6px_6px_0px_0px] active:shadow-[0px_0px_0px_0px] active:translate-x-1 active:translate-y-1 shadow-red-700 dark:shadow-red-500 bg-red-600 dark:bg-red-700 px-6 py-3 font-semibold"
