...
import { availableWbjeeYears, mostRecentWbjeeOrcr, wbjeeRoundByYearsGlobal } from "@/constants";
...
export default function Wbjee() {
  ...
  const [requiredFilters, setRequiredFilters] = useState<requiredFiltersType>({
    exam: "WBJEE",
    year: mostRecentWbjeeOrcr.year,
    round: mostRecentWbjeeOrcr.round,
  });
  ...
  const {
    ...
    queryKey: ['wbjeeOrcrData', requiredFilters],
