...
export default function MobileSidebar() {
    ...
    return (
        <div className="absolute z-10 w-full">
            ...
            ></div>
            <div
                className={`fixed h-full w-80 rounded-r-xl border-r-2 flex flex-col top-0 left-0 pt-20 pb-6 border-black dark:border-white justify-start items-start bg-gray-100 dark:bg-[#292929] shadow-md transition-all duration-300 ease-in-out ${
