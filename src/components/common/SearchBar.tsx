        ...
        <div className="flex flex-wrap gap-3">
          {filters.map((filter) => (
            <select
              ...
              className="px-4 py-2 text-sm md:text-base bg-white dark:bg-[#1a1a1a] text-black dark:text-white border-3 border-black dark:border-white rounded-lg shadow-[3px_3px_0px_0px] hover:shadow-[4px_4px_0px_0px] shadow-black dark:shadow-white transition-all"
          ...
          {Object.keys(activeFilters).length > 0 && (
            <button
              ...
              className="px-4 py-2 text-sm md:text-base text-red-700 dark:text-red-400 border-3 border-red-500 dark:border-red-600 rounded-lg hover:bg-red-50 dark:hover:bg-red-950/20 transition-colors font-medium"
