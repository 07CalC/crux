...
const main = async () => {
    ...
    for (const college of colleges){
        if (college.name.includes("Indian Institute of Technology")) {
            await prisma.college.update({
                where: {
                    name: college.name,
                },
        ...
        else if (college.name.includes("Birla Institute of Technology and Science")) {
            await prisma.college.update({
                where: {
                    name: college.name,
                },
        ...
        else if (college.name.includes("National Institute of Technology")) {
            await prisma.college.update({
                where: {
                    name: college.name,
                },
        ...
        else if (college.name.includes("Indian Institute of Information Technology") && (!college.name.toLocaleLowerCase().includes("hyderabad") || !college.name.toLocaleLowerCase().includes("bangalore"))){ {
            await prisma.college.update({
                where: {
                    name: college.name,
                },
